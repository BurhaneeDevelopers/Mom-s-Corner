      ...
      <label htmlFor="my-modal-1" className="modal cursor-pointer">
        ...
        >
          ...
          <div className="text-gray-900 text-justify mt-5">
            <h3 className="text-lg font-bold mb-2">Welcome to Mom's Corner!</h3>
            ...
            <p className="mb-2">
              Unless otherwise stated, Mom's Corner and/or its licensors own the
              intellectual property rights for all material on Mom's Corner. All
              intellectual property rights are reserved. You may access this
              from Mom's Corner for your own personal use subjected to
            ...
            <ul>
              ...
              <li>Reproduce, duplicate or copy material from Mom's Corner</li>
            ...
            <p className="mb-2">
              ...
              Mom's Corner does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Mom's Corner,its agents and/or
              ...
              applicable laws, Mom's Corner shall not be liable for the Comments
            ...
            <p className="mb-2">
              Mom's Corner reserves the right to monitor all Comments and to
            ...
            <p className="mb-2">
              ...
              by sending an e-mail to Mom's Corner. Please include your name,
            ...
            <p className="mb-5">
              No use of Mom's Corner's logo or other artwork will be allowed for
        ...
        >
          ...
          <div className="py-4 text-gray-900 text-justify">
            ...
            <p className="mb-5">
              ...
              collected and recorded by Mom's Corner and how we use it. If you
            ...
            <p className="mb-5">
              ...
              that they shared and/or collect in Mom's Corner. This policy is
            ...
            <p className="mb-2">
              ...
              the advertising partners of Mom's Corner. Third-party ad servers
              ...
              that appear on Mom's Corner, which are sent directly to users'
            ...
            <p className="mb-2">
              Mom's Corner's Privacy Policy does not apply to other advertisers
            ...
            <p>
              Mom's Corner does not knowingly collect any Personal Identifiable
